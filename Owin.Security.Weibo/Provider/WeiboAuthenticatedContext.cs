...
namespace Owin.Security.Weibo
{
    ...
    public class WeiboAuthenticatedContext : BaseContext
    {
        ...
        public WeiboAuthenticatedContext(IOwinContext context, JObject user, JObject userInfo, string accessToken, 
            ...
            : base(context)
        {
            ...
            Id = userId.ToString();
            Name = userInfo["name"] == null ? "" : userInfo["name"].ToString();
