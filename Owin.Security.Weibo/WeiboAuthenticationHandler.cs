...
namespace Owin.Security.Weibo
{
    internal class WeiboAuthenticationHandler : AuthenticationHandler<WeiboAuthenticationOptions>
    {
        ...
        private const string GraphApiEndpoint = "https://api.weibo.com/2/account/get_uid.json";
        ...
        protected override async Task<AuthenticationTicket> AuthenticateCoreAsync()
        {
            ...
            try
            {
                ...
                HttpResponseMessage userInfoResponse = await _httpClient.GetAsync(
                    ...
                    + "&uid=" + Uri.EscapeDataString(accountInformation["uid"].ToString())
                ...
                var context = new WeiboAuthenticatedContext(Context, accountInformation, userInformation, accessToken,
                    refreshToken, expire);
                context.Identity = new ClaimsIdentity(
                    new[]
                    {
                        ...
                        new Claim("urn:Weibo:id", context.Id, "http://www.w3.org/2001/XMLSchema#string", Options.AuthenticationType),
                        new Claim("urn:Weibo:name", context.Name, "http://www.w3.org/2001/XMLSchema#string", Options.AuthenticationType)
                    },
        ...
        protected override Task ApplyResponseChallengeAsync()
        {
            ...
            if (challenge != null)
            {
                ...
                var redirectContext = new WeiboApplyRedirectContext(
                    Context, Options,
